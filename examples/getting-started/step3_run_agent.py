...
from bnbagent.apex.server.routes import create_apex_state, create_apex_routes
...
def process_task(description: str) -> str:
    ...
    This is where you put your AI logic. For this getting-started example,
        ...
        try:
            ...
            for job in jobs:
                ...
                submission = await state.job_ops.submit_result(
                    ...
                    metadata={"agent": "getting-started"},
                )
