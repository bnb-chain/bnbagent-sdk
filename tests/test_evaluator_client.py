...
class TestReadMethods:
    ...
    def test_job_assertion_initiated(self, evaluator_client):
        evaluator_client.contract.functions.jobAssertionInitiated.return_value.call.return_value = True
    ...
    def test_assertion_to_job(self, evaluator_client):
        ...
        evaluator_client.contract.functions.__dict__["assertionToJob"] = MagicMock(return_value=fn_mock)
...
class TestWriteMethods:
    def _mock_send_tx(self, client):
        client._send_tx = MagicMock(return_value={
