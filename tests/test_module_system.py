...
from bnbagent.core.config import BNBAgentConfig, NetworkConfig
...
class TestModuleRegistry:
    ...
    def test_initialize_missing_dependency_raises(self):
        from bnbagent.core.exceptions import ConfigurationError
...
class TestBNBAgentConfig:
    ...
    def test_from_env(self, monkeypatch):
        monkeypatch.setenv("PRIVATE_KEY", "0xtest")
        config = BNBAgentConfig.from_env()
        assert config.private_key == "0xtest"
