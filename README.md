...
| `AltanaWalletProvider` | [Altana](https://docs.altana.network) EIP-7702 wallet, on-chain session keys | TypeScript | self-broadcasting via relay; session-key x402 payer (Altana SDK >= 0.3.4) |
